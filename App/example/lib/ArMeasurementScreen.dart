...
class _ArMeasurementScreenState extends State<ArMeasurementScreen> {
  ...
  void onARViewCreated(ARKitController arKitController)
  {
    ...
    {
      final planeTap = ar.firstWhere((tap) => tap.type == ARKitHitTestResultType.existingPlaneUsingExtent, orElse: () => null);

      if(planeTap 1= null)
      {
        onPlaneTapHander(planeTap.worldTransform);
      }
    }
  }
  ...
  void onPlaneTapHander(Matrix4 transform)
  {
    ...
    final material = ARKitMaterial(
      ...
      diffuse: ARKitMaterialProperty(
        color: const Color.fromRGBO(255,153,83,1)
      ),
    );
    ...
    if(lastPosition != null)
    {
      final line = ARKitLine(
        fromVector: lastPosition, toVector: position
      );
